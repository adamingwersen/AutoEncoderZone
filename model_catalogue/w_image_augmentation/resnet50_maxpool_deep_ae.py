...
#rom vgg16_places_365 import VGG16_Places365
...
model_name = 'resnet50_maxpool_deep_ae'
...
""" Extend ResNet50 w. Deep Autoencoder """
# Model hyperparams
noise_factor = None
regularization = None
bottleneck_size = 512
...
encoded = K.layers.Dense(1028, activation = 'relu')(encoded)
encoded = K.layers.Dense(bottleneck_size, activation = 'relu')(encoded)

decoded = K.layers.Dense(1028, activation = 'relu')(encoded)
decoded = K.layers.Dense(2048, activation = 'relu')(decoded)
decoded = K.layers.Dense(autoencoder_input, activation = 'sigmoid')(decoded)

resnet50_maxpool_deep_ae = K.models.Model(input_layer, decoded)
encoder = K.models.Model(input_layer, encoded)

resnet50_maxpool_deep_ae.compile(optimizer = 'adadelta', loss = 'mse')

callbacks = utils.get_callbacks(model_name)

resnet50_maxpool_deep_ae.fit(train_feature_vecs, train_feature_vecs,
...
""" Save the Model """
resnet50_maxpool_deep_ae.save(weights_path + model_name + '.hdf5')
