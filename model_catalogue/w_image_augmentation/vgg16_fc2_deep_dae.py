...
model_name = 'vgg16_fc2_deep_dae_with_preprocess-5-3-15-relu'
...
places365_fc1 = K.models.Model(places_365_full.input, places_365_full.get_layer('fc2').output)
...
encoded = K.layers.Dense(5000, activation = 'relu')(input_layer)
encoded = K.layers.Dense(3000, activation = 'relu')(encoded)
encoded = K.layers.Dense(bottleneck_size, activation = 'relu')(encoded)

decoded = K.layers.Dense(3000, activation = 'relu')(encoded)
decoded = K.layers.Dense(5000, activation = 'relu')(decoded)
