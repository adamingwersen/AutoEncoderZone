...
encoded = K.layers.Dense(6272, activation = 'relu')(input_layer)
#encoded = K.layers.Dense(6272, activation = 'relu')(encoded)
encoded = K.layers.Dense(3136, activation = 'relu')(encoded)

encoded = K.layers.Dense(bottleneck_size, activation = 'relu')(encoded)

decoded = K.layers.Dense(3136, activation = 'relu')(encoded)
decoded = K.layers.Dense(6272, activation = 'relu')(decoded)
#decoded = K.layers.Dense(12544, activation = 'relu')(decoded)
...
results_dict = {
    ...
    "regularization": regularization, #regularization.get_config(),
    "noise": noise_factor,
